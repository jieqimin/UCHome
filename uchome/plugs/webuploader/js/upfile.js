...
function Upfiles(options) {
    ...
    this.innertext = "请选择上传文件";
    this.tip = "【提示：单个文件请不要超过5M】";
    this.extensions = "gif,jpg,jpeg,bmp,png,docx,doc,xlsx,xls,txt,zip,rar,ppt,pptx";
    this.fileNumLimit = 300;
    this.init(options);
}
Upfiles.prototype = {
    ...
    init: function (options) {
        ...
        this.fileNumLimit = options.fileNumLimit;
        this.tip = typeof (options.tip) == "undefined" ? this.tip : options.tip;
        this.innertext = typeof (options.innertext) == "undefined" ? this.innertext : options.innertext;
        this.CreateDom();
    ...
    CreateDom: function () {
        ...
        obj += "<div class=\"pull-left\" id=\"" + upfileid + "picker\">"+this.innertext+"</div>";
