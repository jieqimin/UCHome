tempApp.controller("index", appmanController);
...
tempApp.factory("errorcontrollindexHttpService", ['$http', function ($http) {
    var service = {};
    service.getData = function () {
        return $http.get('http://jp.taedu.gov.cn:84/uchomenew/ErrorCollection/GetErrorCollections');
    };
    service.addData = function (newApp, relation) {
        return $http({
            method: 'POST',
    ...
    service.getDataByPKID = function (pkid) {
        return $http.get('http://jp.taedu.gov.cn:84/uchomenew/ErrorCollection/GetErrorCollectionByPKID?pkid='+pkid);
    };
    service.deleteData = function (pkid) {
        return $http.get('http://jp.taedu.gov.cn:84/uchomenew/ErrorCollection/DeleteErrorCollection?pkid=' + pkid);
    };
    service.changeerrorcollectionstatus = function (pkid, status) {
        return $http.get('http://jp.taedu.gov.cn:84/uchomenew/ErrorCollection/ChangeStatus?pkid=' + pkid + '&status=' + status);
    };
    service.updateData = function (newApp) {
        return $http({
            method: 'POST',
