    ...
    var module = {
        ...
        slip: function () {
            if (supports('transition')) {
                ...
                module.container.stop().animate({ left: -module.npos * module.sWidth }, 800);
            }
        },
        ...
        pager: function () {
            var nav = $('<div class="slider-nav-container"><ul class="slider-nav"><li class="hiddenli"><a href="#" class="control prev">Prev</a></li><li class="hiddenli"><a href="#" class="control next">Next</a></li></ul></div>');
            return nav;
        },
        items: function (i) {
